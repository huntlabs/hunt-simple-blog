...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 2018-01-23 07:12:17
-- 服务器版本： 5.7.19
-- PHP Version: 5.6.31
...
CREATE TABLE IF NOT EXISTS `hb_commentmeta` (
...
(1, 1, '一位WordPress评论者', 'wapuu@wordpress.example', 'https://wordpress.org/', '', '2018-01-23 15:10:27', '2018-01-23 07:10:27', '嗨，这是一条评论。\n要开始审核、编辑及删除评论，请访问仪表盘的“评论”页面。\n评论者头像来自<a href=\"https://gravatar.com\">Gravatar</a>。', 0, '1', '', '', 0, 0);
...
(3, 'blogname', 'HuntBlog', 'yes'),
(4, 'blogdescription', '又一个WordPress站点', 'yes'),
(5, 'users_can_register', '0', 'yes'),
(6, 'admin_email', 'demo@huntframework.com', 'yes'),
...
(125, '_site_transient_update_themes', 'O:8:\"stdClass\":4:{s:12:\"last_checked\";i:1516691490;s:7:\"checked\";a:3:{s:13:\"twentyfifteen\";s:3:\"1.9\";s:15:\"twentyseventeen\";s:3:\"1.4\";s:13:\"twentysixteen\";s:3:\"1.4\";}s:8:\"response\";a:0:{}s:12:\"translations\";a:0:{}}', 'no'),
...
(118, '_site_transient_timeout_theme_roots', '1516693237', 'no'),
...
(127, 'auto_core_update_notified', 'a:4:{s:4:\"type\";s:7:\"success\";s:5:\"email\";s:22:\"demo@huntframework.com\";s:7:\"version\";s:5:\"4.9.2\";s:9:\"timestamp\";i:1516691487;}', 'no');
...
CREATE TABLE IF NOT EXISTS `hb_postmeta` (
  `meta_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
(1, 1, '2018-01-23 15:10:27', '2018-01-23 07:10:27', '欢迎使用WordPress。这是您的第一篇文章。编辑或删除它，然后开始写作吧！', '世界，您好！', '', 'publish', 'open', 'open', '', 'hello-world', '', '', '2018-01-23 15:10:27', '2018-01-23 07:10:27', '', 0, 'http://localhost/wordpress/?p=1', 0, 'post', '', 1),
(2, 1, '2018-01-23 15:10:27', '2018-01-23 07:10:27', '这是示范页面。页面和博客文章不同，它的位置是固定的，通常会在站点导航栏显示。很多用户都创建一个“关于”页面，向访客介绍自己。例如：\n\n<blockquote>欢迎！我白天是个邮递员，晚上就是个有抱负的演员。这是我的博客。我住在天朝的帝都，有条叫做Jack的狗。</blockquote>\n\n……或这个：\n\n<blockquote>XYZ Doohickey公司成立于1971年，自从建立以来，我们一直向社会贡献着优秀doohickies。我们的公司总部位于天朝魔都，有着超过两千名员工，对魔都政府税收有着巨大贡献。</blockquote>\n\n而您，作为一个WordPress用户，我们建议您访问<a href=\"http://localhost/wordpress/wp-admin/\">控制板</a>，删除本页面，然后添加您自己的页面。祝您使用愉快！', '示例页面', '', 'publish', 'closed', 'open', '', 'sample-page', '', '', '2018-01-23 15:10:27', '2018-01-23 07:10:27', '', 0, 'http://localhost/wordpress/?page_id=2', 0, 'page', '', 0);
...
CREATE TABLE IF NOT EXISTS `hb_termmeta` (
  `meta_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
INSERT INTO `hb_terms` (`term_id`, `name`, `slug`, `term_group`) VALUES
...
--
-- 表的结构 `hb_term_taxonomy`
--

DROP TABLE IF EXISTS `hb_term_taxonomy`;
CREATE TABLE IF NOT EXISTS `hb_term_taxonomy` (
...
CREATE TABLE IF NOT EXISTS `hb_usermeta` (
...
(1, 'demo', '$P$B5RG4jKpnpKbRc7IaJ70580uktYbSn1', 'demo', 'demo@huntframework.com', '', '2018-01-23 07:10:27', '', 0, 'demo');
COMMIT;
